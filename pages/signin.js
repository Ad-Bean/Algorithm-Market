...
export default function signup() {
  return (
    <div className="flex justify-center px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="shadow-lg flex flex-col max-w-md p-6 rounded-md sm:p-10 dark:bg-gray-100">
        <div className="mb-8 text-center">
          <h1 className="my-3 text-4xl font-bold"> 登录 </h1>
          <p className="text-sm dark:text-gray-900">Sign in to access your account</p>
        </div>
